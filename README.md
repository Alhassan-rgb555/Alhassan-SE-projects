...
** Technologies: C++, Arduino IDE, Embedded Logic.
...
** Technologies: HTML5, CSS3, JavaScript (planned migration to PHP/PostgreSQL).
** Status: In-Development (Active).
** [Click here to view the project](https://github.com/Alhassan-rgb555/Alhassan-SE-projects/blob/main/Interactive-Art-Showcase-Website/index.html)
